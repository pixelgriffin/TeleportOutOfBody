...
public class VRUIPointer : MonoBehaviour
{
    ...
    {
        return (controller.controller != null ? true : false);
    }
    ...
    {
        return (controller.controller != null ? controller.controller.GetPress(SteamVR_Controller.ButtonMask.Trigger) : false);
    }
    ...
    protected virtual void LateUpdate()
    {
        ...
        {
            pointerEventData.pointerId = (int)controller.controller.index;//(int)VRTK_ControllerReference.GetRealIndex(controllerReference);
        }
